...
@connect(
  ({ flow: { pack, actions, navigation, meta, input, vars,packsForUser }}) => ({ pack, actions, navigation, meta, input, vars,packsForUser }),
  (dispatch) => ({
...
export default class Meta extends Component {
  ...
  render() {
    const { pack, setPack, meta, setMeta, navigation, actions, vars,packsForUser } = this.props;
    ...
    return ([
      ...
      section === 'meta' && (
        <Panel key="meta">
          ...
          <EnumField name="Pack" value={pack} spec={{enum: packsForUser, default: packs}} onChange={(v) => setPack(v)} />
